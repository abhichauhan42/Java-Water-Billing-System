...
public class CalculateBill extends JFrame implements ActionListener{
    ...
    JTextField tfname, tfaddress, tfstate, tflitres, tfemail, tfphone;
    JButton next, cancel;
    ...
    CalculateBill() {
        ...
        JLabel lblcity = new JLabel("Litres Consumed");
        lblcity.setBounds(100, 200, 100, 20);
        p.add(lblcity);
        
        tflitres = new JTextField();
        tflitres.setBounds(240, 200, 200, 20);
        p.add(tflitres);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            String litres = tflitres.getText();
            String month = cmonth.getSelectedItem();
            
            int totalbill = 0;
            int litres_consumed = Integer.parseInt(litres);
            ...
            try {
                ...
                while(rs.next()) {
                    totalbill += litres_consumed * Integer.parseInt(rs.getString("cost_per_litres"));
            ...
            String query2 = "insert into bill values('"+meter+"', '"+month+"', '"+litres+"', '"+totalbill+"', 'Not Paid')";
