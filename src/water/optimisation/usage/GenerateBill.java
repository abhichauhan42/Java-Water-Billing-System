...
public class GenerateBill extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            area.setText("\tWater corporation limited\nWater Bill BILL GENERATED FOR THE MONTH\n\tOF "+month+", 2022\n\n\n");
            ...
            if(rs.next()) {
                area.append("\n");
                area.append("\n    Cost Per litres: " + rs.getString("cost_per_litres"));
            ...
            if(rs.next()) {
                ...
                area.append("\n    litres Consumed:     " + rs.getString("litres"));
